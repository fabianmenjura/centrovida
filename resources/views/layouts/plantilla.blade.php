            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{route('listreport')}}" aria-expanded="false"><i class="fas fa-users"></i><span class="hide-menu">Reportes</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{route('vsisben')}}"  aria-expanded="false"><i class="fa fa-link"></i><span class="hide-menu">Consulta SISBEN</span></a></li>

                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="https://docs.google.com/forms/d/e/1FAIpQLScJr9-tJItM0Td1Ttw872ygGZZQx-ZQ3wXiHprKiy4hi3jHAg/viewform" target="_blank" aria-expanded="false"><i class="fa fa-medkit"></i><span class="hide-menu">COVID-19</span></a></li>
...
<!-- Datatables -->
 ...
 <!-- Bootstrap -->
 <script src="pla/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
  <!-- FastClick -->
  <script src="pla/fastclick/lib/fastclick.js"></script>
  <!-- NProgress -->
  <script src="pla/nprogress/nprogress.js"></script>
  <!-- Chart.js -->
  <script src="pla/Chart.js/dist/Chart.min.js"></script>
  <!-- gauge.js -->
  <script src="pla/gauge.js/dist/gauge.min.js"></script>
    <!-- bootstrap-progressbar -->
    <script src="pla/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
 <!-- iCheck -->
 <script src="pla/iCheck/icheck.min.js"></script>
 <!-- Skycons -->
 <script src="pla/skycons/skycons.js"></script>
 <!-- Flot -->
 <script src="pla/Flot/jquery.flot.js"></script>
 <script src="pla/Flot/jquery.flot.pie.js"></script>
 <script src="pla/Flot/jquery.flot.time.js"></script>
 <script src="pla/Flot/jquery.flot.stack.js"></script>
 <script src="pla/Flot/jquery.flot.resize.js"></script>
 <!-- Flot plugins -->
 <script src="pla/flot.orderbars/js/jquery.flot.orderBars.js"></script>
 <script src="pla/flot-spline/js/jquery.flot.spline.min.js"></script>
 <script src="pla/flot.curvedlines/curvedLines.js"></script>
 <!-- DateJS -->
 <script src="pla/DateJS/build/date.js"></script>
 <!-- JQVMap -->
 <script src="pla/jqvmap/dist/jquery.vmap.js"></script>
 <script src="pla/jqvmap/dist/maps/jquery.vmap.world.js"></script>
 <script src="pla/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
 <!-- bootstrap-daterangepicker -->
 <script src="pla/moment/min/moment.min.js"></script>
 <script src="pla/bootstrap-daterangepicker/daterangepicker.js"></script>
